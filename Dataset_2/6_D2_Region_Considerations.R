...
## Graph Output
pdf(file.path(PATH, "Dataset_2", "4_Integration_results", "Region_analysis_ChIPseeker D2.pdf"), height = 10, width = 15)
...
## Output
write.xlsx(Stats_df, file.path(PATH, "Dataset_2", "4_Integration_results", "Stats_table_region.xlsx"), rowNames = FALSE)