...
RNAseq_universe <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/1_RNA-Seq/dataset_1/RNAseq_universe.csv", col.names = c("SYMBOL", "log2FoldChange", "padj"))
...
for(METHOD in 1:5) {
  ...
  # Summary dataframe
  single_DM <- DM_sites %>% filter(SYMBOL %in% DM_num$SYMBOLgene[DM_num$n_DM_sites < 2])
...
Stats_table <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/4_Integration_results/dataset_1/Stats_table.csv")
...
#Writing on file
write.csv(Stats_table_final, "C:/Users/pierp/Desktop/THESIS PROJECT/4_Integration_results/dataset_1/Stats_table_final.csv", row.names = FALSE)


##Plotting graphs:
pdf("C:/Users/pierp/Desktop/THESIS PROJECT/4_Integration_results/dataset_1/Additional_comparison.pdf", height = 10, width = 15)

plot_grid(plotlist = magnitude_list, nrow = 2, ncol= 3)
plot_grid(plotlist = num_barplot_list, nrow = 2, ncol= 3)
plot_grid(plotlist = scatter_list, nrow = 2, ncol= 3)
