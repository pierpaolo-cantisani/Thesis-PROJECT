...
pdf("C:/Users/pierp/Desktop/THESIS PROJECT/4_Integration_results/dataset_1/Base_comparison.pdf")

##### --- PIPELINE 0: Simple Intersection --- #####

#Importing RNA-Seq DE genes
sign_DE <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/1_RNA-Seq/dataset_1/DE_results.csv")
sign_DE <- sign_DE %>% dplyr::rename(SYMBOL = hugo_symbol)  #renaming for coherence


#Importing BS-Seq DM sites
M_list <- list()
M_list[[1]] <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met1.csv")
M_list[[2]] <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met2.csv")
M_list[[3]] <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met3.csv")
M_list[[4]] <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met4.csv")
M_list[[5]] <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met5.csv")
...
write.csv(Upset_genes_df, "C:/Users/pierp/Desktop/THESIS PROJECT/4_Integration_results/dataset_1/Upset_genes.csv", row.names = FALSE)
...
dds <- readRDS("C:/Users/pierp/Desktop/THESIS PROJECT/1_RNA-Seq/dataset_1/dds.rds")
meth25p <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/2_BS-Seq/dataset_1/meth25p.csv")
sign_DE <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/1_RNA-Seq/dataset_1/DE_results.csv")
names(sign_DE)[names(sign_DE) == "hugo_symbol"] <- "SYMBOL"

#This will be different for the different lists:
M1_df <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met1.csv")
M2_df <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met2.csv")
M3_df <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met3.csv")
M4_df <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met4.csv")
M5_df <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/3_Benchmark/dataset_1/DM_sites_Met5.csv")
...
##Importing files
meth25p <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/2_BS-Seq/dataset_1/meth25p.csv")
rnaseq_all <- read.csv("C:/Users/pierp/Desktop/THESIS PROJECT/1_RNA-Seq/dataset_1/RNAseq_universe.csv")
...
write.csv(Stats_table, "C:/Users/pierp/Desktop/THESIS PROJECT/4_Integration_results/dataset_1/Stats_table.csv", row.names = FALSE)
...
#Spear_val_list <- list()
#for(m in seq_along(Method_final_df)) {
#  corr <- cor.test(Method_final_df[[m]][, "Mv"], Method_final_df[[m]][, "log2FC"], method = 'spearman')
#  res <- data.frame(rho = unname(corr$estimate), pvalue = corr$p.value)

#  Spear_val_list[[m]] <- res
#}
#names(Spear_val_list) <- names(Method_final_df)
