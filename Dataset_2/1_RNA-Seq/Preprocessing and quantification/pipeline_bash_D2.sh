...
for ((i=38; i<=85; i++)); do
  ...
  case $i in
    49|63|65|66|67|72|84)
      echo "Skipping SRR63419${i}"
      continue
      ;;
  esa
  ...
  fastp \
    -w 2 \
    --in1 "fastq/SRR63419${i}.fastq.gz" \
    --out1 "fastq_trimmed/SRR63419${i}_trimmed.fastq.gz" \
    --html "fastq_trimmed/SRR63419${i}_fastp.html" \
    --json "fastq_trimmed/SRR63419${i}_fastp.json" \
    --qualified_quality_phred 20 \
    --length_required 40 && \
  rm "fastq/SRR63419${i}.fastq.gz"
