...
setwd("C:/Users/pierp/Desktop/THESIS PROJECT/2_BS-Seq/dataset_1")

pdf("C:/Users/pierp/Desktop/THESIS PROJECT/2_BS-Seq/dataset_1/WGBS Graphs.pdf", width = 12, height = 8)
...
##Now liftover and exporting the meth25p

##Before liftover, exporting coverage and methylation data on DM sites:
meth <- readRDS("C:/Users/pierp/Desktop/THESIS PROJECT/2_BS-Seq/dataset_1/meth.rds")
...
meth_df$coord_key <- paste(meth_df$seqnames, meth_df$start, sep="_")
myDiff25p_GR_hg38_df <- as.data.frame(myDiff25p_GR_hg38)
...
#Karyo visualization
pdf("C:/Users/pierp/Desktop/THESIS PROJECT/2_BS-Seq/dataset_1/Chr DM distribution.pdf", width = 12, height = 8)
