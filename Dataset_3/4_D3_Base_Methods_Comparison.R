...
#Reordering vst_expr_matrix from interleaved
...
## Subtracting "D0" from "D28" for each donor
#Methylation
...
plot_sig_bar <- function(df, res_list, title) {
  #Keeping method order M1..M5 (not alphabetical surprises)
...
#Obtaining the delta matrix (D0_mean and D28 were already called in PIP 1)
